...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Leaderboard view.
        // Guarded: CREATE OR REPLACE VIEW, CONCAT() and DATE_FORMAT() are
        // MySQL-specific and are a syntax error on the sqlite :memory:
        // connection phpunit.xml runs tests on. RecognitionController reads
        // this view, so any test touching that path must target MySQL.
