            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('succession.candidates.store') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="hims-label">9-Box Label</label>
                            <select name="nine_box_label" class="hims-input hims-select">
                                <option value="star">⭐ Future Star (High Perf / High Pot)</option>
                                <option value="high">🔝 High Performer</option>
                                <option value="solid">✅ Solid Contributor</option>
                                <option value="potential">🌱 High Potential</option>
                                <option value="core">👷 Core Employee</option>
                                <option value="diamond">💎 Rough Diamond</option>
                                <option value="avg">📊 Average</option>
                                <option value="inconsist">⚠️ Inconsistent</option>
                                <option value="under">🔴 Underperformer</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="performance_score" class="hims-input" value="{{ old('performance_score') }}" min="1" max="5" step="0.01" placeholder="e.g. 4.25">
                        </div>
                        <div class="col-md-6">
                            <label class="hims-label">Potential Score (1–5)</label>
                            <input type="number" name="potential_score" class="hims-input" value="{{ old('potential_score') }}" min="1" max="5" step="0.01" placeholder="e.g. 4.50">
                        </div>
